...
namespace MGT2API.Difficulty.Hooks
{
    ...
    internal static class SellGameHooks
    {
        ...
        internal static bool Prefix(ref gameScript __instance)
        {
            ...
            try
            {
                SellGameManager.SellGameRefactored(__instance);
            }
            catch (Exception ex)
            {
        ...
        private static class SellGameManager
        {
            ...
            public static void SellGameRefactored(gameScript instance)
            {
                SellGameManager.instance = instance;
                ...
                */
                ...
                if (!instance.arcade)
                {
                    ...
                    if (estimatedSales > 0f)
                    {
                                ...
                                if (instance.gamePlatformScript[l])
                                {
                                    if (instance.exklusiv && instance.gamePlatformScript[l].OwnerIsNPC() && !instance.gamePlatformScript[l].vomMarktGenommen)
                                    {
                                        if (instance.gameTyp != 2)
                                        {
                                            ...
                                            int exclusivePlatformSaleBonus = Mathf.RoundToInt(UnityEngine.Random.Range((float)instance.sellsPerWeek[0] * 0.2f, (float)instance.sellsPerWeek[0] * 0.3f));
                                            exclusivePlatformSaleBonus = exclusivePlatformSaleBonus / 100 * (130 - (int)instance.gamePlatformScript[l].GetMarktanteil());
                        ...
                        {
                            //nu47: 利用可能なプラットフォームユニットと予測される売上との差分 -> availableUnitsAfterSales
                ...
                */
                    ...
                    estimatedSales *= SetGameSalesBasedOnRealisticPowerAndSalesImpact(instance.mS_.difficulty, realismSalesDecreaseImpactFactor);
                    if (estimatedSales < 0f)
                    {
                        estimatedSales = 0f;
                    }
                    ...
                    else
                    {
                        if (instance.gameTyp != 2)
                        {
                            ...
                            // アーケードゲームの売上収益 -> arcadeGameRevenue
            ...
            /// <returns></returns>
            static float SetGameSalesBasedOnRealisticPowerAndSalesImpact(int difficulty, float realismImpactFactor)
            {
                /*
